...
/**
 *
 * @param {payload} passwordResetToken, toEmail, fullName
 * @returns {object} - mailjet response body
 */
const sendPasswordResetTokenMail = async ({
  passwordResetToken,
  toEmail,
  fullName,
}: {
                          ...
                          >
                            ...
                            >
                              <span style="color: #27272b; font-family: Times New Roman; font-size: 32px"
                                ><b>click the link below to reset your password!</b></span
                              >
                            </h1>
                          </div>
                        </td>
                            ...
                            <tbody>
                              <tr>
                                <td
                                  ...
                                  valign="middle"
                                >
                                    <a style="text-decoration: none; cursor: pointer" href=${URL}/user/rsp/${passwordResetToken} >
                                  <p
                                    style="
                                      display: inline-block;
                                      background: #3d86ff;
                                      ...
                                      border-radius: 0px;
                                    "
                                  ><span style="font-size: 16px; cursor: pointer"><b>reset</b></span>
                                </p>
                              </a>
                                </td>
                              </tr>
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              ...
                              ><span style="color: #27272b; font-family: Arial; font-size: 16px"> to unsubscribe.</span>
                            </p>
                          </div>
                        </td>
                      </tr>
